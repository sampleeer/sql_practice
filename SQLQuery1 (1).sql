...
-- Заполнение данными таблицы Doctor
...
-- Заполнение данными таблицы Station
...
-- Заполнение данными таблицы Schedule
...
-- Заполнение данными таблицы Address
...
-- Заполнение данными таблицы Patient
...
-- Заполнение данными таблицы Ticket
...
-- Заполнение данными таблицы Appointment
...
VALUES
(1, '2024-01-01', 'Головная боль', 'Мигрень', 'Принять анальгин', 1, 3, 1, 123456789, 1),
(2, '2024-01-02', 'Боль в животе', 'Гастрит', 'Прописать антибиотики', 1, 5,  2, 987654321, 2),
(3, '2024-01-03', 'Рвота и температура', 'Пищевое отравление', 'Принимать уголь и обильное питье', 1, 3,  3, 567890123, 3),
(4, '2024-01-04', 'Температура, кашель', 'ОРВИ', 'Отдых и принять антипиретик', 1, 7, 3, 567890123, 4),
(5, '2024-01-05', 'Боли в спине', 'Остеохондроз', 'Физиотерапия и массаж', 0, 10,  4, 345678912, 5),
(6, '2024-01-06', 'Бессонница', 'Невроз', 'Назначить успокоительное', 0, 5,  5, 789012345, 6),
(7, '2024-01-07', 'Покраснение глаз', 'Конъюнктивит', 'Капли от воспаления', 1, 3,  1, 123456789, 7),
(8, '2024-01-08', 'Потеря аппетита', 'Дисбактериоз', 'Пробиотики и диета', 1, 7,  3, 567890123, 8),
(9, '2024-01-09', 'Зубная боль', 'Кариес', 'Пломбирование и анестезия', 1, 2,  2, 987654321, 9),
(10, '2024-01-10', 'Тахикардия', 'Стресс', 'Рекомендации по уменьшению стресса', 0, 3,  3, 567890123, 10);